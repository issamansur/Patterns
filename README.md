...
## 1. Ducks_and_patterns (Стратегия)
...
## 2. Weatherdata_and_patterns (Наблюдатель)
...
## 3. Beverages_and_patterns (Декоратор)
...
## 4. Pizza_and_patterns (Фабричный метод/Фабрика)
### 4.1 Simple Fabric
...
## 9 Pattern method (Шаблонный метод)
...
## 10 Iterator (+ Component) (Итератор и компоновщик)
### 10.1 Iterator
